...
export default function Goa300hrSeatsAddPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmitted(true);
      setTimeout(() => {
        router.push("/admin/yogacourse/best-yoga-goa-in-india/yoga-goa-300hr-seats");
      }, 1500);
    } catch (err: any) {
  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.breadcrumb}>
        <Link href="/admin/yogacourse/best-yoga-goa-in-india/yoga-goa-300hr-seats" className={styles.breadcrumbLink}>
      ...
      <div className={styles.formCard}>
        ...
        <div className={styles.sectionBlock}>
          ...
          {form.totalSeats && !isNaN(Number(form.totalSeats)) && Number(form.totalSeats) > 0 && (
            <div className={styles.seatsPreview}>
              ...
              <span className={styles.seatsPreviewNote}>(It will automatically be reduced whenever a new registration is received)</span>
            </div>
          )}
        </div>
        ...
        <div className={styles.formActions}>
          <Link href="/admin/yogacourse/best-yoga-goa-in-india/yoga-goa-300hr-seats" className={styles.cancelBtn}>
            ← Cancel
          </Link>
          <button
            type="button"
